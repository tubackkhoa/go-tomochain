...
func (f *Fetcher) doRequest(ctx context.Context, gone chan *discover.NodeID, peersToSkip *sync.Map, sources []*discover.NodeID, hopCount uint8) ([]*discover.NodeID, error) {
	var i int
